Possibility to add min / max amount of product
---

We will enable the addition of a function that will allow us to set the minimum, maximum quantity of any product, as well as multiples of addition to the cart.
